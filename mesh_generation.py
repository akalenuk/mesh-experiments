...
def add_tri(f, a, p1, p2, p0, i1, i2, vs, ts):
    ...
    add_tri(f, a, p1, new_snapped_point, p2, i1, new_point_i, vs, ts)
    add_tri(f, a, new_snapped_point, p2, p1, new_point_i, i2, vs, ts)
...
if __name__ == "__main__":
    ...
    add_tri(SDF, a, vs[0], vs[1],  snap(SDF, [a, 0., 1.]), 0, 1, vs, ts)
