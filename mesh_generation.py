...
def add_tri(f, a, p1, p2, p0, i1, i2, in1, in2, vs, ts):
    ...
    new_point_dir = normialized(cross_of(old_norm, sub_of(p2, p1)))
    ...
    add_tri(f, a, p1, new_snapped_point, i1, new_point_i, in1, in_vs, vs, ts)
    add_tri(f, a, p2, new_snapped_point, i2, new_point_i, in2, in_vs, vs, ts)
...
if __name__ == "__main__":
    ...
    add_tri(SDF, 0.8, first_tri_ps[0], first_tri_ps[1], 0, 1, True, True, vs, ts)
    add_tri(SDF, 0.8, first_tri_ps[1], first_tri_ps[2], 1, 2, True, True, vs, ts)
    add_tri(SDF, 0.8, first_tri_ps[2], first_tri_ps[0], 2, 0, True, True, vs, ts)
